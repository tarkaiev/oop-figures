public class Main {
    public static void main(String[] args) {
        Figure[] figures = new Figure[1 + (int) (Math.random() * 10)];  //массив, содержащий от 1 до 10 фигур
    ...
    public static Figure randomFigure(){
        ...
        switch (randomizer){
            ...
            case (2) :{
                ...
                //в треугольнике обходится ограничение, что 2 стороны в сумме должны всегда быть больше третьей
